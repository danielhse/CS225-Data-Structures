...
bool heap<T, Compare>::hasAChild(size_t currentIdx) const
{
    ...
    if(currentIdx * 2 + 1 < _elems.size() || currentIdx * 2 < _elems.size() ) 
        return true;
    return false;
}
...
size_t heap<T, Compare>::maxPriorityChild(size_t currentIdx) const
{
    ...
    if (higherPriority(_elems[leftChild(currentIdx)], _elems[rightChild(currentIdx)]) == 0) 
