...
//PNG png1;
//png.readFromFile("tests/rickroll_4k.jpg");
/*
...
*/
FloodFilledImage image(png);
BFS bfs(png, Point((png.width()/2) - 80, png.height()/2 + 75), 0.05);
MyColorPicker myColor;
image.addFloodFill( bfs, myColor);
/*
SolidColorPicker blue(HSLAPixel(200, 1, .5));
//FloodFilledImage images(png);
MyColorPicker mycolorpicker("tests/rickroll_4k.png");
image.addFloodFill(bfs, blue);
image.addFloodFill(bfs2, mycolorpicker);
*/

RainbowColorPicker rainbow(0.45);
DFS dfs(png, Point(png.width()/2, png.height()/2), 0.34);
